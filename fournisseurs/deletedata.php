    ...
    if ($resultat = $connexion->query($req)) {
        echo "
            <div class='alert alert-success alert-dismissible' role='alert' style='width: 60%; margin-right: auto; margin-left: auto'>
                ...
                <strong>Succès!</strong> Le fournisseur " . $id . " a été supprimé.
            </div>
            ";
    } else {
        echo "
            <div class='alert alert-danger alert-dismissible' role='alert' style='width: 60%; margin-right: auto; margin-left: auto'>
                ...
                <strong>Erreur!</strong> Une erreur s'est produite lors de la tentative de suppression du fournisseur " . $id . ". Veuillez contacter l'administrateur.
            </div>
            ";
    }
} else {
