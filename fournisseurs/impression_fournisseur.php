...
$sql = "SELECT * FROM fournisseur where code_four='" . $id . "'";
...
EDO;
    ...
    foreach ($ligne as $list) {
        ...
        $societe_four=utf8_encode($list['societe_four']);
        $nom_four = utf8_encode($list['nom_four']). ' ' .utf8_encode($list['prenoms_four']) ;
        $fonction_four = utf8_encode($list['fonction_four']);
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('liste_fournisseurs.pdf', 'I');
