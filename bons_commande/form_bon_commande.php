                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="panel panel-default">
                                            <table border="0" class="table table-hover table-bordered">
                                                <tr>
                                                    <td class="entete" style="text-align: center">Libelle</td>
                                                    ...
                                                    <td class="entete" style="text-align: center">Prix TTC</td>
                                                </tr>
                                                <?php
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="entete" style="text-align: center" colspan="4">TOTAL</td>
                                                    <td class="entete"
...
//                        console.log(option[i]);
    ...
    if (sizeof($_POST) > 0) {
        ...
        $date_bon = date("Y-m-d");
        $code_emp = htmlspecialchars($_POST['code_emp'], ENT_QUOTES); //$_SESSION['user_id'];
...
//            rediriger('form_principale.php?page=bons/bons_commande/form_bon_commande');
            ...
            <div class='alert alert-danger alert-dismissible' role='alert' style='width: 60%; margin-right: auto; margin-left: auto'>
                ...
                <strong>Une erreur s'est produite lors de la tentative d'enregistrement du bon de commande. Veuillez contacter l'administrateur.</strong>
            </div>
            ";
        }
